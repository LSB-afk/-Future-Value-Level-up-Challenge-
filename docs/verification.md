...
확인일: 2026-06-11 (데이터 정밀도 1차 + 탭형 화면 전환 반영)
...
- `python3 -m py_compile api/movevalue_api.py scripts/build_real_dataset.py scripts/movevalue_adapters.py` 통과
...
- `지도` 화면: `map`만 표시, Leaflet 마커 9개, 지도 높이 487px로 표시
